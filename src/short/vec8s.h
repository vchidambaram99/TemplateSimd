...
namespace TSimd{
    ...
    public:
        ...
        TSIMD_INLINE vec<short,8> operator&(const vec<short,8>& rhs) const {
            return vec<short,8>(_mm_and_si128(data,rhs.data));
        }
        TSIMD_INLINE vec<short,8> operator|(const vec<short,8>& rhs) const {
            return vec<short,8>(_mm_or_si128(data,rhs.data));
        }
        TSIMD_INLINE vec<short,8> operator^(const vec<short,8>& rhs) const {
            return vec<short,8>(_mm_xor_si128(data,rhs.data));
        }
        ...
        TSIMD_INLINE vec<short,8> operator==(const vec<short,8>& a) const {
